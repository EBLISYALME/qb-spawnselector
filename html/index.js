$(document).ready(function(){
    ...
    function createButtons(data) { 
        var len = data.length
        for (i=0; i < len; i++) {
            $(".spawn-points").append('<div class="themap"><img style="padding-bottom: 2%;"src="https://cdn.discordapp.com/attachments/897994953907666954/944740252453585006/mapgtav.png" alt=""></div>');
    ...
    $(document).on("click", ".lastspawn", function(e){
        $(".container").fadeOut(500)
        $.post('https://spawnselector/sonkonum', JSON.stringify({coords: pos}));
         $('#info').hide()
    });
